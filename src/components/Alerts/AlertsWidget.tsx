  ...
  const [alerts, setAlerts] = useState<Alert[]>([
    {
      ...
      message: 'You have exceeded your Food budget by ₹2,500',
    ...
    },
    {
      ...
      message: 'Your spending is 35% above your monthly average',
    ...
    },
    {
      ...
      message: '₹15,000 transaction detected at an unfamiliar location',
          ...
          {recentAlerts.map((alert) => (
            <div
              ...
              className={`p-4 rounded-3xl border ${getSeverityColor(
                alert.severity
              )} ${!alert.read ? 'ring-1 ring-white/20' : ''} transition-all hover:border-white/20`}
            >
